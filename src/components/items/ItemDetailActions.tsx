...
export default function ItemDetailActions({
        ...
        <div className="flex flex-col gap-2 p-3 bg-amber-50 border border-amber-200 rounded-xl">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-2.5 text-sm border border-gray-300 rounded-lg text-gray-600 active:bg-gray-50 transition"
            >
              Cancel
            </button>
  ...
  const buyerActions = (
    <div className="flex items-stretch gap-2">
      ...
      {item.status === 'sold' && (
        <div className="flex-1 text-center py-2.5 bg-gray-100 text-gray-500 rounded-lg text-sm font-medium">
          This item is sold
        </div>
      )}
      <button
        ...
        className={cn(
          'w-11 h-11 sm:w-12 sm:h-12 rounded-xl border flex items-center justify-center transition flex-shrink-0 self-end',
          favorited
      ...
      <button
        ...
        className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl border border-gray-300 flex items-center justify-center text-gray-500 active:bg-gray-50 transition flex-shrink-0 self-end"
      >
  ...
  return (
    <>
      ...
      {/* Mobile: fixed bar above bottom nav (nav already includes safe-area) */}
      <div className="md:hidden fixed bottom-16 left-0 right-0 z-40 bg-white/95 backdrop-blur-sm border-t border-gray-200 px-3 py-2.5 shadow-[0_-4px_12px_rgba(0,0,0,0.06)]">
      ...
      {/* Spacer for fixed action bar + bottom nav */}
